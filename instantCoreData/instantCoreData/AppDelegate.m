...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.navigationVC = [[UINavigationController alloc] initWithRootViewController:self.viewController];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle]URLForResource:@"instantCoreData"withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]URLByAppendingPathComponent:@"instantCoreData.sqlite"];
    NSError *error = nil;
